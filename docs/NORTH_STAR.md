...
> **지시문 8개 ~4,314**(적정성 축 — 조용한 증가만 차단) · **발화 표면 26개 ~3,368**(유지 축, 스킬별 상한만) ·
> 합계 34개 ~7,682 이 설치자가 실제로 무는 전부다.
> 내역: rules 6개 ~1,360 · CLAUDE.md 2개 ~2,954 · skill 17개 ~2,643 · agent 9개 ~725.
> (2026-09-13: skill −156 — `audit-harness-fit` 2판의 descriptor 가 짧아졌다, ADR-084. 직전 발화 표면 26개 ~3,524 · 합계 ~7,838.)
>
