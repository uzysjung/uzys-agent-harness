...
> 실측(tooling 트랙): **상주 ~6,156 tokens/세션** = rules ~4,053 · CLAUDE.md ~938 ·
> agent descriptors ~615 · skill descriptors ~550. 발화 = 기본 설치 8종 전부 트리거 시 ~26,930.
> **2026-07-19 하루에 5,194 → 6,156 (+18%)** — 전부 룰 증분이다(재발방지 3건 + no-false-ship
...
> **-18**(4,071 → 4,053) — 상주 비용이 줄어든 첫 사례다.
