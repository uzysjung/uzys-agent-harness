...
> **지시문 8개 ~3,506**(적정성 축 — 조용한 증가만 차단) · **발화 표면 12개 ~2,142**(유지 축, 스킬별 상한만) ·
> 합계 20개 ~5,648 이 설치자가 실제로 무는 전부다.
> 내역: rules 6개 ~1,268 · CLAUDE.md 2개 ~2,238 · skill 10개 ~1,950 · agent 2개 ~192.
