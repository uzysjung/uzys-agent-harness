...
- **R6** (Phase C CR Minor, 2026-05-12 승인): csr-supabase 옵션 섹션 `supabase-auth`을 SECTIONS에 추가 (총 9 섹션). `## Supabase 인증 설정` 헤더 자동 생성. 다른 트랙은 fragment 없으므로 R4로 자동 생략. Boundaries 다음 위치.
