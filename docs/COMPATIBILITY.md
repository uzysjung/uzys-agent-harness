...
> **자동 생성** (`scripts/gen-compatibility.mjs`, 2026-06-06). 자산 **48** (official 6 / vetted 38 / experimental 4) · 🟢 검증 **45/48**. tier SSOT=`src/external-assets.ts`, drift 감시=`trust-tier-drift.yml`.
