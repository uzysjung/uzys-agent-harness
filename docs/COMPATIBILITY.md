...
> **자동 생성** (`scripts/gen-compatibility.mjs`, 2026-06-06). 자산 **52** (official 6 / vetted 41 / experimental 5) · 🟢 검증 **49/52**. tier SSOT=`src/external-assets.ts`, drift 감시=`trust-tier-drift.yml`.
...
| id | tier | 설치 타겟 | CLI | 검증 |
|---|---|---|---|---|
| `frontend-slides` | vetted | `frontend-slides@frontend-slides` | Claude Code | 🟢 Docker 2026-06-06 |
| `marp-slide` | vetted | `softaworks/agent-toolkit :: marp-slide` | Claude Code (+skills.sh) | 🟢 Docker 2026-06-06 |
| `mermaid-diagrams` | vetted | `softaworks/agent-toolkit :: mermaid-diagrams` | Claude Code (+skills.sh) | 🟢 Docker 2026-06-06 |
| `gsap-skills` | vetted | `gsap-skills@gsap-skills` | Claude Code | 🟢 Docker 2026-06-06 |
| `remotion` | vetted | `remotion-dev/skills :: remotion-best-practices` | Claude Code (+skills.sh) | 🟢 Docker 2026-06-06 |
| `ppt-master` | vetted | `hugohe3/ppt-master :: ppt-master` | Claude Code (+skills.sh) | 🟢 Docker 2026-06-06 |
| `ppt-generation` | vetted | `bytedance/deer-flow :: ppt-generation` | Claude Code (+skills.sh) | 🟢 Docker 2026-06-06 |
| `web-video-presentation` | vetted | `ConardLi/garden-skills :: web-video-presentation` | Claude Code (+skills.sh) | 🟢 Docker 2026-06-06 |
| `revealjs` | experimental | `ryanbbrown/revealjs-skill :: revealjs` | Claude Code (+skills.sh) | 🟢 Docker 2026-06-06 |
