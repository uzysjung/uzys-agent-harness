...
> **자동 생성** (`scripts/gen-compatibility.mjs`, 2026-06-06). 자산 **41** (official 4 / vetted 33 / experimental 4) · 🟢 검증 **40/41**. tier SSOT=`src/external-assets.ts`, drift 감시=`trust-tier-drift.yml`.
