...
> **자동 생성** (`scripts/gen-compatibility.mjs`). 자산 **57** (official 11 / vetted 41 / experimental 5) · 🟢 검증 **49/57**. tier SSOT=`src/external-assets.ts`, drift 감시=`trust-tier-drift.yml`.
>
